{{-- resources/views/ticket/layout/index.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <aside class="fixed top-0 left-0 z-40 h-screen transition-transform duration-300"
            ...
            <div class="h-full w-64 bg-white border-r border-gray-200">
                ...
                <nav class="p-4 space-y-2">
                    ...
                    <a href="{{ route('ticketing.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('ticketing.users') ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
